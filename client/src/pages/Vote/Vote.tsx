...
const Vote = () => {
	...
	useEffect(() => {
		...
		dispatch.spaceModel.getSpaceData("hedsv2.1");
				...
				<div className="max-w-[100rem] mx-auto">
					...
					<div className="flex flex-col md:flex-row mt-2 gap-x-1">
						<div className="w-full md:w-7/12">
							<div className="bg-neutral-975 w-full py-2 px-2 mb-1 rounded-lg">
						...
						<div className="w-full md:w-5/12 md:mt-0 mt-2">
							<div className="bg-neutral-975 w-full py-2 px-2 mb-1 rounded-lg">
								<div className="flex font-serif items-center justify-between text-neutral-400 text-center sm:text-2xl text-xl py-2 px-4 bg-neutral-950 rounded-sm">
									{"RESULTS"}
									<div className="flex items-center justify-center text-neutral-400 text-center text-xs bg-neutral-950 py- rounded-sm">
										proposal:{" "}
