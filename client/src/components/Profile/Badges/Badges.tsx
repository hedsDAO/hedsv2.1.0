...
const Badges = (userData: UserState) => {
	return (
		<div className="col-span-12 mt-5">
			<h1 className="col-span-12 text-2xl tracking-widest font-semibold text-neutral-500 px-2 mb-2">BADGES</h1>
						...
						{badgeEmptyState(userData.badges).map((badge, index: number) => {
							if (badge?.image?.length) {
								return (
									<div
										key={badge.name}
										className="flex items-center justify-start w-full bg-neutral-300 dark:bg-neutral-850 dark:text-neutral-300 text-neutral-900 rounded-md p-2 col-span-12 lg:col-span-3 lg:row-span-1">
								...
								return (
									<div
										...
										className="hidden lg:flex items-center justify-start w-full bg-neutral-500 dark:bg-neutral-800 text-neutral-500 rounded-md p-2 col-span-6 lg:col-span-3 lg:row-span-1">
										<div className="flex flex-col items-start justify-end mx-3">
											<span className="font-serif font-extrabold tracking-tight uppercase text-right text-sm">
												{badge.name}
											</span>
