		...
		<div className="col-span-12 lg:col-span-auto mt-5">
			<Fragment>
				{Object.values(userData?.collection)?.length ? (
					<h1 className="col-span-12 text-2xl tracking-widest font-semibold text-neutral-500 px-2.5 mb-2">COLLECTION</h1>
				) : null}
				<div className="grid grid-cols-2 xl:grid-cols-6 place-items-center items-center gap-y-1 gap-x-1 bg-neutral-400 dark:bg-neutral-900 p-1 rounded-md mx-2">
					{Object.values(userData?.collection)?.length
								...
								if (tape.quantity > 0) {
									...
									return (
										<div
											...
											className="hidden lg:inline max-w-full max-h-full xl:min-h-[182px] xl:min-w-[182px] rounded-lg bg-neutral-500 dark:bg-neutral-850"></div>
									);
								}
						  })
						: null}
