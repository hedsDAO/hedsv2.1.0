	...
	return (
		<div className="col-span-12 lg:col-span-auto mt-5">
			<Fragment>
				...
				<div className="grid grid-cols-2 xl:grid-cols-6 place-items-center items-center gap-y-1 gap-x-2 bg-neutral-400 dark:bg-neutral-700 p-2 rounded-md mx-2">
					{Object.values(userData?.collection)?.length
								...
								if (tape.quantity > 0) {
									...
									return (
										<div
											...
											className="hidden lg:inline max-w-full max-h-full xl:min-h-[182px] xl:min-w-[182px] rounded-lg bg-neutral-300 dark:bg-neutral-800"></div>
									);
								}
						  })
						: null}
