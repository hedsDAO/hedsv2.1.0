			...
			<div className="bg-neutral-900 py-7 rounded-lg">
				<div className="lg:mx-auto lg:max-w-xl lg:grid lg:grid-cols-2 gap-x-4">
					<div className="col-span-1 flex flex-col items-center justify-baseline px-2 lg:py-2 py-1 lg:max-w-[18rem] md:max-h-[18rem] max-h-[12rem]">
						<img
							className="lg:w-full md:min-w-[18rem] md:min-h-[18rem] max-w-[12rem] min-w-[12rem] min-h-[12rem] md:max-w-md object-cover bg-neutral-900 mx-auto lg:ml-auto rounded-lg "
					...
					<div className="col-span-1 self-center">
						<div className="mx-auto px-5 lg:px-8 lg:py-3">
							<div className="flex flex-col md:justify-start justify-center">
								...
								<div className="lg:py-1.5 py-3 lg:px-0 px-20 rounded-lg text-neutral-300 text-[0.8em] lg:text-left tracking-wider text-center lg:max-w-xs mb-3 lg:mx-1.5 break-words">
