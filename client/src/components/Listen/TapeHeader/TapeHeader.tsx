...
const TapeHeader = (tapeData: TapeData) => {
    ...
    return (
        <div className="xl:mx-auto">
            <div className="lg:z-10 bg-gray-300 dark:bg-neutral-900 rounded-xl lg:max-w-[100rem] p-2 mx-2 xl:mx-auto xl:mt-5 shadow-sm">
                <div className="lg:max-w-4xl lg:px-1 py-8 lg:grid lg:grid-cols-5 lg:gap-2 lg:mx-auto items-center">
                    <div className="flex justify-center lg:col-span-2 px-2">
                        <img
                            className="object-contain rounded-xl w-[85%] sm:w-[50%] lg:w-[19rem] bg-neutral-975 shadow-sm"
                    ...
                    <div className="lg:col-span-3">
                            ...
                            <div className="col-span-12 lg:px-0 px-2 lg:col-span-1 h-full flex items-center justify-center lg:justify-start">
                                <div className="flex flex-col justify-start items-center lg:items-start lg:mt-0 mt-10">
                                    <div className="flex items-center justify-start mb-4">
                                        <img
                                            src={
                                                tapeData?.sample?.image || tapeData?.collab?.curator
                                            }
                                    ...
                                    <div className="inline-flex items-center">
                                        <span className="dark:text-neutral-400 text-neutral-600 font-serif text-xs mt-2 mb-1 tracking-widest whitespace-nowrap pr-1 py-1 mr-0.5">
                                            {tape}
                                        </span>
                                        <span className="dark:text-neutral-400 text-neutral-600 font-serif text-xs mt-2 mb-1 tracking-widest whitespace-nowrap pr-1 py-1 mr-0.5">
                                            /
                                    ...
                                    <span className="dark:text-neutral-100 text-neutral-900 text-xl xl:text-2xl uppercase tracking-widest whitespace-nowrap mb-3">
                        ...
                        <div className="px-10 lg:max-w-xl ">
                            <div className="flex flex-col md:items-start items-center">
                                <div className="lg:px-0 px-5 bg-opacity-6 dark:text-gray-400 text-neutral-700 text-xs text-center md:text-left tracking-widest min-h-[75px] lg:pb-0 lg:pt-0 pb-10 pt-5">
