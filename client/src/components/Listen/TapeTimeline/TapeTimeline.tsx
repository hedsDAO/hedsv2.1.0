...
const TapeTimeline = (tapeData: TapeData) => {
	...
	return (
		<div className="">
			{tapeData?.tape && (
				<nav className="xl:mx-auto mx-2 max-w-[80rem] p-1 bg-neutral-400 dark:bg-neutral-975 rounded-lg mt-1.5" aria-label="Progress">
...
const Completed = ({ step, idx }: any) => {
	return (
		<li key={step.key} className="relative overflow-hidden lg:flex-1 bg-neutral-500 dark:bg-neutral-950 rounded-md lg:m-0 m-1 group">
			<span
...
const Current = ({ modal, step, idx }: any) => {
	return (
		<li key={step.key} className="relative overflow-hidden lg:flex-1 bg-neutral-500 hover:bg-neutral-950 dark:bg-neutral-900 rounded-md transition-all">
...
const Pending = ({ step, idx }: any) => {
	return (
		<li key={step.key} className="relative overflow-hidden lg:flex-1 dark:bg-neutral-950 rounded-md group">
			<span
