...
const TapeTimeline = (tapeData: TapeData) => {
	return (
		<div className="">
			{tapeData?.tape && (
				<nav className="lg:mx-auto mx-2 max-w-[100rem] p-2 bg-neutral-975 rounded-lg mt-1.5" aria-label="Progress">
			...
			<a href={step.href} className="group ">
				...
				<span className={classNames(idx !== 0 ? "lg:pl-9" : "", "px-6 py-5 flex items-start text-sm font-medium")}>
					<span className="flex-shrink-0">
						<span className="w-8 h-8 flex items-center justify-center bg-opacity-60 bg-green-900 rounded-full mx-1.5 pt-">
