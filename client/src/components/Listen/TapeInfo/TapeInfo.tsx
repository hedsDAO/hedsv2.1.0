...
const TapeInfo = (tapeData: TapeData) => {
	...
	return (
		<div className="lg:max-w-[80rem] mx-auto w-full">
			<div className="inline-flex justify-start items-baseline rounded-md px-1.5 w-full xl:mt-8 mt-5 mb-1.5">
				<i className="fa-regular fa-list-ul text-neutral-700 dark:text-neutral-400 text-xs place-self-center self-center -mb-0.25" />
				<span className="text-neutral-700 dark:text-neutral-400 tracking-widest px-3 font-medium text-lg">DETAILS</span>
			</div>
			<div className="max-w-[80rem] w-full bg-gray-300 dark:bg-neutral-975 p-1 rounded-md mx-auto">
				<div className="grid lg:grid-cols-6 grid-cols-1 items-center rounded-md w-full gap-1">
					<div className="col-span-1 inline-flex items-center lg:justify-center justify-start w-full bg-neutral-200 dark:bg-neutral-900 px-4 py-1.5 rounded-md">
						<span
					...
					<div className="col-span-1 inline-flex items-center lg:justify-center justify-start gap-x-2 w-full bg-neutral-200 dark:bg-neutral-900 px-4 py-1.5 rounded-md">
