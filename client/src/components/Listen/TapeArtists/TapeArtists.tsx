...
const TapeArtists = (tapeData: TapeState) => {
	...
	return (
		<div className="w-full mx-auto">
			{tapeData && (
				<Fragment>
					<div className="bg-gray-500 dark:bg-neutral-975 rounded-md xl:rounded-none mx-auto xl:w-screen">
						<div className="w-full bg-gray-300 dark:bg-neutral-975 xl:rounded-none rounded-md mx-auto">
