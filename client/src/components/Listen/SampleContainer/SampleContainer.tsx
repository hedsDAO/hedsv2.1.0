...
const SampleContainer = (tapeData: TapeData) => {
	return (
		<div className="grid grid-cols-12 gap-x-2 max-w-lg mx-auto mt-2 px-4 py-3 sm:p-6 bg-neutral-950  border-neutral-800 shadow-sm border-[0.25px] sm:rounded-lg -mb-10">
