...
const NavDropdown = () => {
	...
	return (
		<Menu as="div" className="flex items-stretch text-left h-[24px]">
			<Menu.Button className="inline-flex items-center justify-center px-3 hover:bg-neutral-800 bg-neutral-500 dark:bg-neutral-700 text-neutral-200 font-serif rounded-sm uppercase transition-all">
				{({ open }) => (
					<DotsHorizontalIcon
			...
			<Transition
				...
				<Menu.Items className="origin-top-right absolute right-8 mt-9 w-32 shadow-lg dark:bg-neutral-800 bg-neutral-950 ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
					<div className="">
						<Menu.Item>
							{() => (
								<button
