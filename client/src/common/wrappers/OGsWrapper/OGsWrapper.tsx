...
import TokenBurnModal from "../../modals/TokenBurnModal/TokenBurnModal";
import { whitelist, tokenMapping } from "../../../data/whitelist";
...
const OGsWrapper = ({ children }: any) => {
	...
	useEffect(() => {
		if (user && isAuthenticated) {
			...
			if (whitelist.includes(ethAddress) && !badges) {
