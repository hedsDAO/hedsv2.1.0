...
const SubmissionModal = () => {
    ...
    const submissionData: Array<string> = [
        currentSubmission,
        walletId,
    ...
    const prevSub = useSelector(
        (state: RootState) =>
            state.submissionsModel?.userSubmissions?.audio?.[space]?.[tape]?.[id] || false
    );
    ...
    const handleSubmit = async () => {
        ...
        if (userData?.twitterHandle && subId && duration) {
            const options = handlePinataMetadata(
                walletId,
                userData.twitterHandle,
                subId?.data,
                space,
                                        ...
                                        {prevSub && !isResubmitting ? (
                                            <div className="flex flex-col h-full items-center justify-center py-5">
                                                <p className="text-sm font-thin text-neutral-400 max-w-[50%] text-center mx-auto">
                                                    You have previously submitted. Do you want to
                                                    replace the{" "}
                                                    <a
                                                        target={"_blank"}
                                                        href={prevSub}
                                            ...
                                            <main className="max-w-lg mx-auto">
                                                <div className="flex flex-col h-full items-center justify-center py-5 mt-1">
                                                    ...
                                                    <div className="text-neutral-400 uppercase text-xs mb-3">
                                                        {"Submission recieved."}
                                                    </div>
                                                    <button
                                                        onClick={() =>
                                            ...
                                            <Fragment>
                                                ...
                                                <p className="text-sm text-neutral-400 mb-4 max-w-[50%] text-center mx-auto">
                                                    Submit your flip of the sample for a chance to
                                                    be on the tape.
                                                </p>
                                                <div className="mb-2">
                                                    <div className="flex justify-center flex-col gap-y-3">
                                                        ...
                                                        <div className="grid grid-cols-4 items-center bg-neutral-900 p-4 rounded-lg max-w-[95%] mx-auto">
                                                            ...
                                                            <div className="flex flex-col items-start justify-center rounded-lg col-span-3">
                                                                ...
                                                                <p className="text-xs text-neutral-400 tracking-wide">
                                                                    Submissions must be{" "}
                                                                    {currentTape?.sample?.bpm} bpm
                                                                    and between 60 to 90 seconds
                                                                    long.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div className="grid grid-cols-4 items-center bg-neutral-900 p-4 rounded-lg mb-4 max-w-[95%] mx-auto">
                                                            ...
                                                            <div className="flex flex-col items-start justify-center rounded-lg col-span-3">
                                                                ...
                                                                <p className="text-xs text-neutral-400 tracking-wide">
                                                                    Submissions that do that follow
                                                                    the guidelines can be subject to
                                                                    disqualification.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <small className="mx-auto text-center font-thin mt-1 mb-3 text-neutral-500 pl-2">
                                                            {error ? (
                                                    ...
                                                    <Fragment>
                                                        <div className="flex justify-center items-center h-5 mt-2">
                                                            <input
                                                                id="comments"
                                                                onChange={() =>
                                                                ...
                                                                name="comments"
                                                                type="checkbox"
                                                                className="focus:ring-transparent h-3 w-3 text-indigo-600 border-gray-300 rounded"
                                                            />
                                                            <span
                                                    ...
                                                    <div className="gap-x-2 flex justify-center items-stretch pt-4 mt-5 pb-2">
                                                        <button
                                                            ...
                                                            disabled={!currentSubmission || !acceptedTerms}
