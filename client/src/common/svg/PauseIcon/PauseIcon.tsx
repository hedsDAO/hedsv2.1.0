...
const PauseIcon = (wavesurfer: React.MutableRefObject<any>) => {
	...
	return (
		<Pause
			...
			className="w-7 h-7 lg:w-6 lg:h-6 text-center text-neutral-900 dark:text-neutral-300 z-40 group-hover:text-fuchsia-900 transition-all ease-in-out duration-200"
			aria-hidden="true"
		/>
	);
};
